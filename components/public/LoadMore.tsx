  ...
  return (
    <div className="mt-12 flex justify-center">
      <Button
        ...
        variant="outline"
        size="lg"
        className="min-w-[220px] rounded-2xl border-white/80 bg-white transition-all duration-200 hover:-translate-y-0.5 hover:border-[color:var(--accent-red)] hover:shadow-[0_20px_40px_-28px_rgba(17,24,39,0.45)] active:scale-95"
      >
        {isLoading ? (
          <>
